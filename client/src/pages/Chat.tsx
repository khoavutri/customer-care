...
const Chat = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: 'Xin chào! Tôi là AI Assistant của bạn. Tôi có thể giúp gì cho bạn hôm nay?',
      sender: 'assistant',
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    setTimeout(() => {
      const aiResponse: Message = {
        ...
        content: 'Cảm ơn bạn đã nhắn tin! Đây là phản hồi mẫu từ AI Assistant. Tôi đang ở đây để hỗ trợ bạn với bất kỳ câu hỏi nào.',
        sender: 'assistant',
        timestamp: new Date()
      };
      ...
      <div className="border-t bg-card/50 backdrop-blur-sm p-4">
        <div className="flex space-x-3">
          <Input
            ...
            className="flex-1 h-12 rounded-xl border-muted focus:border-primary transition-colors"
            disabled={isTyping}
          />
          <Button
